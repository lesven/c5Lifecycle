.PHONY: help setup build up down restart logs status clean test test-unit test-integration test-js test-e2e test-e2e-headed setup-e2e-user stan lint lint-fix coverage migrate deploy create-admin
